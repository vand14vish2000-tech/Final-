            ...
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker-hub', 
                    ...
                    sh '''
                        ...
                        # Dynamically find the real image names/IDs generated by your docker-compose build
                        ...
                        echo "Found local frontend build: $REAL_FRONTEND"
                        echo "Found local backend build: $REAL_BACKEND"
                        
                        # Tag your local images for your cloud Docker Hub repository
        ...
        stage('Deploy to Kubernetes (KinD on EC2)') {
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker-hub', 
                                                  ...
                                                  usernameVariable: 'DOCKER_NAMESPACE')]) {
                    sh """
                        # 1. Load the freshly built cloud-tagged images straight into your local KinD cluster nodes
